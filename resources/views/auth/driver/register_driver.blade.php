        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Register Driver</h4></div>

              <div class="card-body">
                <form method="POST" action="{{route('register.store.driver')}}">
                  @csrf
                  <div class="form-row">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" id="city" name="city" placeholder="Masukan Kota">
                    </div>
                    <div class="form-group col-md-6">
