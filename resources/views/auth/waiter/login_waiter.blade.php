          ...
          <div class="row">
            <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
              ...
              <div class="card card-primary">
                <div class="card-header"><h4>Login Waiter</h4></div>

                <div class="card-body">
                  <form action="{{ route('login.custom.waiter') }}" method="POST" class="needs-validation" novalidate="">
                    @csrf
              ...
              <div class="mt-5 text-muted text-center">Don't have an account? <a href="{{route('register.waiter')}}">Create One</a></div>
